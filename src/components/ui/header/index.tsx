    ...
    return (
        <header className="bg-zinc-950 shadow-sm top-0 z-10 w-full">
            <div className="max-w-[1280px] mx-auto px-4 flex justify-between items-center py-4">
                ...
                <h1 className="flex flex-row text-2xl font-black text-orange-400">
                    <img
                        src={bitcoinLogo}
                        alt="Bitcoin Logo"
                ...
                <nav>
                    <ul className="flex flex-row items-center space-x-4">
                        <li className="border-2 border-gray-500 rounded-sm px-2 py-1 flex items-center">
                        ...
                        <li className="">
                            <a
                                href="#"
                                className="px-2 py-1 text-sm border-2 rounded-sm border-orange-400 text-orange-400 hover:border-orange-500 hover:text-orange-500 transition">
                                Mainnet
                            </a>
                        </li>
                    </ul>
